...
from oldcontrib.media.gallery.models import Gallery, GalleryItem
from oldcontrib.media.image.models import Image
from oldcontrib.media.gallery.admin import GalleryAdmin
...
class GalleryInsert(ModelInsert):
    ...
    def reorder(self, request):
        ...
        for i, ident in enumerate(idents_in_order):
            img = GalleryItem.objects.get(pk=ident)
            img.order = i + 1
            img.save()
        return HttpResponse("")
